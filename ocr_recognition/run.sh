...
function start_trainer() {
  ...
  stdbuf -oL nohup python dist_train.py --average_window 0 --batch_size 256 --eval_period 500 --log_period 100 --local 0 2>&1 > trainer_0.log &
}
...
function start_local() {
  ...
  GLOG_v=0 \
  GLOG_logtostderr=1 \
  stdbuf -oL nohup python dist_train.py --average_window 0 --batch_size 256 --log_period 100 --eval_period 500 --local 1 2>&1 > local_train.log &
}
